...
(1, 'Kieran', 'Pritchard', '23036958@students.southwales.ac.uk', 'Images/Staff/1.webp', 'Admin', '$2y$10$BBBPjyb4tN7wXeVzLmQIP.Q1Ao4br0V63dY1ikKSgo53tXmMp5qmy'),
...
--
ALTER TABLE `tblcustomerlogin`
  MODIFY `CustomerLoginID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tblstaffpermissions`
  MODIFY `StaffPermissionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `tblsystemproduct`
--
ALTER TABLE `tblsystemproduct`
  MODIFY `SystemProductID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
